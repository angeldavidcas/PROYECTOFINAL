...
class trabajador{
    ...
    function save($params){
        ...
        $insert= "INSERT INTO trabajadores VALUES (NULL, '$nombre', '$apellidos', '$email', '$enfermedades', '$cargo', '$imagen', '$fecha')"; 
  ...
  function getAll(){
    ...
    function update($params){
      ...
      $fecha = $params['fecha'];
        ...
        $update = " UPDATE trabajadores SET nombre='$nombre', apellidos='$apellidos', email='$email', enfermedades='$enfermedades', cargo='$cargo', imagen='$imagen', fecha='$fecha' WHERE id = $id";
